    ...
    const quickActions = (index, item) => {
        return (
          <View style={{
            ...
            <TouchableOpacity onPress={() => alterRequest(item, index, 'Reject')} style={styles.requestBtn}>
              <Text style={{ color: Color.white, fontWeight: 'bold', }}>Reject</Text>
